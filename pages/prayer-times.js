...
import PrayerCard from './prayers/prayerCards';
...
<>
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        {/* Main content */}
            <PrayerCard />
            <Fab variant="extended" color="primary" style={style} id="locate">
  <GpsFixedIcon />Get Times</Fab>
      </main>
    </div></>
  );
}
